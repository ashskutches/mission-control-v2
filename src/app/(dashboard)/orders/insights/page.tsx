 ...
 * Orders → Insights
 *
 * What the Orders lead agent has filed, and nothing else. The list, the sorting
...
export default function OrdersInsightsPage() {
  return (
    <InsightsBoard
      ...
      emptyHint={
        <>
          Nothing open for Orders in this lane. Run an analysis from the{" "}
          <a href="/orders" style={{ color: "#64748b" }}>dashboard</a> to populate it.
        </>
      }
    />
  );
