 ...
 * Support → Insights
 *
 * What the Support lead agent has filed, and nothing else. The list, the sorting
...
export default function SupportInsightsPage() {
  return (
    <InsightsBoard
      ...
      emptyHint={
        <>
          Nothing open for Support in this lane. Run an analysis from the{" "}
          <a href="/support" style={{ color: "#64748b" }}>dashboard</a> to populate it.
        </>
      }
    />
  );
