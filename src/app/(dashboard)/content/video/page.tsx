  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "1.5rem" }}>
        ...
        <span style={{ fontSize: 11, color: ACCENT, fontWeight: 700 }}>Video Agent</span>
      </div>
      ...
      <motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }} style={{ marginBottom: "1.5rem" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
          ...
          <div>
            <h1 style={{ fontSize: "1.4rem", fontWeight: 800, color: "#f1f5f9", margin: 0 }}>Universal Video Agent</h1>
            <p style={{ fontSize: 11, color: "#64748b", margin: 0 }}>Generate storyboards from your clip library using AI — review, approve, then render on the Windows worker</p>
          </div>
        </div>
      </motion.div>
