 ...
 * Logistics → Insights
 *
 * What the Logistics lead agent has filed, and nothing else. The list, the sorting
...
export default function LogisticsInsightsPage() {
  return (
    <InsightsBoard
      ...
      emptyHint={
        <>
          Nothing open for Logistics in this lane. Run an analysis from the{" "}
          <a href="/logistics" style={{ color: "#64748b" }}>dashboard</a> to populate it.
        </>
      }
    />
  );
