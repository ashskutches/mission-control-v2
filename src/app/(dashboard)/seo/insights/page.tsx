 ...
 * SEO → Insights
 *
 * What the SEO lead agent has filed, and nothing else. The list, the sorting
...
export default function SeoInsightsPage() {
  return (
    <InsightsBoard
      ...
      emptyHint={
        <>
          Nothing open for SEO in this lane. Run an analysis from the{" "}
          <a href="/seo" style={{ color: "#64748b" }}>dashboard</a> to populate it.
        </>
      }
    />
  );
