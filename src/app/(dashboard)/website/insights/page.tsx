 ...
 * Website → Insights
 *
 * What the Website lead agent has filed, and nothing else. The list, the sorting
...
export default function WebsiteInsightsPage() {
  return (
    <InsightsBoard
      ...
      emptyHint={
        <>
          Nothing open for Website in this lane. Run an analysis from the{" "}
          <a href="/website" style={{ color: "#64748b" }}>dashboard</a> to populate it.
        </>
      }
    />
  );
