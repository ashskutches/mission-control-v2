...
const WORKOUTS: Workout[] = [
  { id:"rebounding-journey-basics-know-your-stance",                                            title:"Know Your Stance",            duration:10, level:"Beginner",     tier:"free", goal:"fundamentals", inst:"Bounce N' Burn",             palette:"cream",  desc:"The foundational stance that makes every bounce safer and more effective." },
  { id:"how-to-use-a-stability-bar-on-your-mini-trampoline",                                    title:"How to Use a Stability Bar",  duration:25, level:"Beginner",     tier:"free", goal:"fundamentals", inst:"Leaps & Rebounds",            palette:"sage",   desc:"The official L&R primer. Perfect for first-timers and seniors." },
  { id:"fun-and-energizing-cardio-routine",                                                     title:"Fun & Energizing Cardio",     duration:15, level:"Intermediate", tier:"free", goal:"cardio",        inst:"Jump&Jacked",                 palette:"peach",  desc:"Upbeat 15 minutes that lifts your spirits while it lifts your heart rate." },
  { id:"get-your-heart-pumping-with-this-20-minute-cardio-rebounder-routine",                   title:"Cardio Rebounder Routine",    duration:20, level:"Intermediate", tier:"free", goal:"cardio",        inst:"Kate's Home Fitness",         palette:"peach",  desc:"A heart-pumping routine that proves rebounding beats the treadmill." },
  { id:"tabata-rebounding-quick-intense-rebounder-workout",                                     title:"Tabata Rebounding",           duration:10, level:"Intermediate", tier:"free", goal:"hiit",          inst:"Renee Lynne",                 palette:"rust",   desc:"Eight rounds of 20-on, 10-off. Fire up your metabolism in under ten." },
  { id:"6-min-everyday-rebounder-workout",                                                      title:"6-Min Everyday Lymph Flow",   duration:6,  level:"All levels",   tier:"free", goal:"lymph",         inst:"Lindsay · Pilates On Demand", palette:"sky",    desc:"Six minutes, six moves, full-body lymphatic flow. Daily-able." },
  { id:"rebounder-resistance-beginners",                                                        title:"Bands for Beginners",         duration:10, level:"Beginner",     tier:"free", goal:"fundamentals",  inst:"Lindsay · Pilates On Demand", palette:"mist",   desc:"Gentle intro to combining resistance bands with bouncing." },
  { id:"no-jumping-rebounder-workout-for-absolute-beginners",                                   title:"No-Jumping for Beginners",    duration:10, level:"Beginner",     tier:"free", goal:"seniors",       inst:"Lindsay · Pilates On Demand", palette:"butter", desc:"Senior-friendly bouncing — no jumps, all benefits." },
  { id:"5-000-steps-mini-trampoline-workout",                                                   title:"5,000 Steps Workout",         duration:40, level:"All levels",   tier:"pro",  goal:"cardio",        inst:"Jump&Jacked",                 palette:"butter", desc:"Hit your daily step goal without leaving the rebounder." },
  { id:"rebounding-arms-medium-resistance-bands",                                               title:"Rebounding Arms + Bands",     duration:21, level:"Intermediate", tier:"pro",  goal:"strength",      inst:"SanFran Fitness",             palette:"mist",   desc:"Trade dumbbells for bands and sculpt arms while you bounce." },
  { id:"10-minute-leaps-rebounds-mini-trampoline-rebounder-workout-130-138bpm",                 title:"130-138 BPM Cardio",          duration:10, level:"Intermediate", tier:"pro",  goal:"cardio",        inst:"Earth & Owl",                 palette:"peach",  desc:"A music-matched bounce session at exactly the BPM your heart loves." },
  { id:"rebounder-mini-trampoline-tabata-style-level-intermediate",                             title:"Tabata Style - Intermediate", duration:30, level:"Intermediate", tier:"pro",  goal:"hiit",          inst:"Bounce N' Burn",              palette:"rust",   desc:"Tabata format on the trampoline. Sweat seriously, recover gently." },
  { id:"rebounding-abdominal-core-workout-10-min",                                              title:"Abdominal Core Workout",      duration:10, level:"All levels",   tier:"pro",  goal:"strength",      inst:"Naomi Joy Fitness",           palette:"sand",   desc:"Standing core work that feels nothing like a sit-up." },
  { id:"rebounder-workout-10-min-kickboxing-style",                                             title:"Kickboxing-Style Rebounder",  duration:10, level:"Intermediate", tier:"pro",  goal:"cardio",        inst:"Renee Lynne",                 palette:"rust",   desc:"Channel your inner fighter — jabs, crosses, and bounces." },
  { id:"beginner-rebounding-workout-with-stability-bar",                                        title:"15 Min to Fit - Balance",     duration:15, level:"Beginner",     tier:"pro",  goal:"balance",       inst:"AngieFitnessTV",              palette:"cream",  desc:"Cardio plus balance work. Builds confidence on the mat." },
  { id:"tiktok-dance-party-15-minute-full-body-workout",                                        title:"Pop Dance Party",             duration:15, level:"All levels",   tier:"pro",  goal:"cardio",        inst:"Jump&Jacked",                 palette:"rose",   desc:"Choreographed bounce to today's biggest pop hits." },
  { id:"bounce-to-beethoven-20-minute-cardio",                                                  title:"Bounce to Beethoven",         duration:20, level:"Intermediate", tier:"pro",  goal:"cardio",        inst:"Kate's Home Fitness",         palette:"sand",   desc:"Classical music meets rebounding. Surprisingly motivating." },
  { id:"ultimate-rebounder-workout-on-and-off-rebounder-full-body",                             title:"50-Min Intervals",            duration:50, level:"Advanced",     tier:"pro",  goal:"hiit",          inst:"Michelle Briehler",           palette:"rust",   desc:"On-and-off the trampoline with weights. Earns its name." },
];
