 ...
 * - Cleaner hero video (capped 880px, orange play btn, vtag, duration pill)
 * - Two-column body: prose article-body left, sticky sidebar right
 * - Sidebar: quick-facts grid, equipment card, dark product CTA, trust marks
 * - "Keep Bouncing" related workouts band
 * - Comments section
 * - Risk-free banner with dashed seal
 *
 * Design tokens: lr-tokens.css palette (charcoal #2B2B2B, orange #FCA248, cream #FAF6F0)
 * Font: Montserrat (replaces Brandon Grotesque, already loaded globally)
 * Motion: Framer Motion only — no CSS @keyframes for UI motion
 */
...
import {
  ...
  Share2, Facebook, Link2, CheckCircle, ArrowRight,
  ShieldCheck, Package, Droplets,
} from "lucide-react";

// ── Brand tokens (from lr-tokens.css / academy index) ─────────────────────────
const C = {
  orange:     "#FCA248",
  orangeDeep: "#E88828",
  orangeSoft: "#FFE2C2",
...
const FD = "'Montserrat','Helvetica Neue',Arial,sans-serif"; // display
const FB = "system-ui,Arial,'Helvetica Neue',sans-serif";   // body
...
const WORKOUTS: Workout[] = [
  { id: "know-stance",    title: "Know Your Stance",            duration: 10, level: "Beginner",     tier: "free", goal: "fundamentals", inst: "Bounce N' Burn",              palette: "cream",  desc: "The foundational stance that makes every bounce safer and more effective.", lede: "Before you bounce into anything else, nail the stance that keeps every move safe, efficient, and effective on the mat.", burn: "~80 cal", goalLabel: "Foundations" },
  { id: "stability-bar",  title: "How to Use a Stability Bar",  duration: 25, level: "Beginner",     tier: "free", goal: "fundamentals", inst: "Leaps & Rebounds",             palette: "sage",   desc: "The official L&R primer. Perfect for first-timers and seniors.", lede: "Your official L&R primer. Whether you just unboxed your rebounder or want to feel more confident, this walkthrough covers everything.", burn: "~160 cal", goalLabel: "Foundations" },
  { id: "fun-cardio",     title: "Fun & Energizing Cardio",     duration: 15, level: "Intermediate", tier: "free", goal: "cardio",        inst: "Jump&Jacked",                  palette: "peach",  desc: "Upbeat 15 minutes that lifts your spirits while it lifts your heart rate.", lede: "Upbeat, dance-to-the-beat cardio that lifts your mood while it lifts your heart rate. Fifteen minutes and you'll feel the difference.", burn: "~120 cal", goalLabel: "Cardio", videoThumb: `${CDN}/files/preview_images/Leaps_Intro_Video_Thumbnail_small.webp?v=1772051635` },
  { id: "20-min-cardio",  title: "Cardio Rebounder Routine",    duration: 20, level: "Intermediate", tier: "free", goal: "cardio",        inst: "Kate's Home Fitness",          palette: "peach",  desc: "A heart-pumping routine that proves rebounding beats the treadmill.", lede: "A heart-pumping 20-minute session that proves the rebounder beats the treadmill — more fun, less impact, same result.", burn: "~180 cal", goalLabel: "Cardio" },
  { id: "tabata-quick",   title: "Tabata Rebounding",           duration: 10, level: "Intermediate", tier: "free", goal: "hiit",          inst: "Renee Lynne",                  palette: "rust",   desc: "Eight rounds of 20-on, 10-off. Fire up your metabolism in under ten.", lede: "Eight rounds of 20-on, 10-off on the trampoline. Fire up your metabolism and you're done in under ten.", burn: "~110 cal", goalLabel: "HIIT" },
  { id: "6-min-lymph",    title: "6-Min Everyday Lymph Flow",   duration: 6,  level: "All levels",   tier: "free", goal: "lymph",         inst: "Lindsay · Pilates On Demand",  palette: "sky",    desc: "Six minutes, six moves, full-body lymphatic flow. Daily-able.", lede: "Six minutes, six moves. Daily lymphatic drainage you'll actually do — gentle, effective, and totally stackable into your morning.", burn: "~40 cal", goalLabel: "Lymphatic" },
  { id: "beginner-bands", title: "Bands for Beginners",         duration: 10, level: "Beginner",     tier: "free", goal: "fundamentals",  inst: "Lindsay · Pilates On Demand",  palette: "mist",   desc: "Gentle intro to combining resistance bands with bouncing.", lede: "A gentle introduction to adding resistance bands to your bounce. More muscle, same low impact — perfect for beginners.", burn: "~70 cal", goalLabel: "Foundations" },
  { id: "no-jump",        title: "No-Jumping for Beginners",    duration: 10, level: "Beginner",     tier: "free", goal: "seniors",       inst: "Lindsay · Pilates On Demand",  palette: "butter", desc: "Senior-friendly bouncing — no jumps, all benefits.", lede: "Senior-friendly rebounding with zero jumps and all the benefits. Gentle on joints, easy on knees, and surprisingly effective.", burn: "~60 cal", goalLabel: "Seniors" },
  { id: "5k-steps",       title: "5,000 Steps Workout",         duration: 40, level: "All levels",   tier: "pro",  goal: "cardio",        inst: "Jump&Jacked",                  palette: "butter", desc: "Hit your daily step goal without leaving the rebounder.", lede: "Hit your daily step goal without leaving the rebounder. Forty fun minutes of low-impact cardio that's gentle on your joints and works your whole body.", burn: "~320 cal", goalLabel: "5,000 Steps", videoThumb: `${CDN}/files/preview_images/Leaps_Intro_Video_Thumbnail_small.webp?v=1772051635` },
  { id: "arms-bands",     title: "Rebounding Arms + Bands",     duration: 21, level: "Intermediate", tier: "pro",  goal: "strength",      inst: "SanFran Fitness",              palette: "mist",   desc: "Trade dumbbells for bands and sculpt arms while you bounce.", lede: "Swap the dumbbells for bands and sculpt your upper body while you bounce. More challenge, less impact, better music.", burn: "~160 cal", goalLabel: "Strength" },
  { id: "130bpm",         title: "130-138 BPM Cardio",          duration: 10, level: "Intermediate", tier: "pro",  goal: "cardio",        inst: "Earth & Owl",                  palette: "peach",  desc: "A music-matched bounce session at exactly the BPM your heart loves.", lede: "A music-matched bounce session calibrated to exactly the BPM your cardiovascular system loves. Ten minutes that feel like a DJ set.", burn: "~90 cal", goalLabel: "Cardio" },
  { id: "tabata-int",     title: "Tabata Style - Intermediate", duration: 30, level: "Intermediate", tier: "pro",  goal: "hiit",          inst: "Bounce N' Burn",               palette: "rust",   desc: "Tabata format on the trampoline. Sweat seriously, recover gently.", lede: "Tabata format on the trampoline. You'll sweat seriously and recover gently — the best possible version of interval training.", burn: "~260 cal", goalLabel: "HIIT" },
  { id: "core-10",        title: "Abdominal Core Workout",      duration: 10, level: "All levels",   tier: "pro",  goal: "strength",      inst: "Naomi Joy Fitness",            palette: "sand",   desc: "Standing core work that feels nothing like a sit-up.", lede: "Standing core work that feels nothing like a sit-up. Your abs will know it happened — no mat required.", burn: "~75 cal", goalLabel: "Strength" },
  { id: "kickbox",        title: "Kickboxing-Style Rebounder",  duration: 10, level: "Intermediate", tier: "pro",  goal: "cardio",        inst: "Renee Lynne",                  palette: "rust",   desc: "Channel your inner fighter — jabs, crosses, and bounces.", lede: "Channel your inner fighter on the trampoline. Jabs, crosses, and bounces — it's cardio with an attitude.", burn: "~95 cal", goalLabel: "Cardio" },
  { id: "balance-fit",    title: "15 Min to Fit - Balance",     duration: 15, level: "Beginner",     tier: "pro",  goal: "balance",       inst: "AngieFitnessTV",               palette: "cream",  desc: "Cardio plus balance work. Builds confidence on the mat.", lede: "Cardio meets balance training. Each move builds confidence on the mat and makes every future bounce feel steadier.", burn: "~100 cal", goalLabel: "Balance" },
  { id: "dance-party",    title: "Pop Dance Party",             duration: 15, level: "All levels",   tier: "pro",  goal: "cardio",        inst: "Jump&Jacked",                  palette: "rose",   desc: "Choreographed bounce to today's biggest pop hits.", lede: "Choreographed bounce to today's biggest pop hits. It counts as cardio if you're smiling the whole time.", burn: "~125 cal", goalLabel: "Cardio" },
  { id: "beethoven",      title: "Bounce to Beethoven",         duration: 20, level: "Intermediate", tier: "pro",  goal: "cardio",        inst: "Kate's Home Fitness",          palette: "sand",   desc: "Classical music meets rebounding. Surprisingly motivating.", lede: "Classical music meets rebounding. Surprisingly, absurdly motivating. Your neighbours will think you're having a very elegant meltdown.", burn: "~155 cal", goalLabel: "Cardio" },
  { id: "intervals-50",   title: "50-Min Intervals",            duration: 50, level: "Advanced",     tier: "pro",  goal: "hiit",          inst: "Michelle Briehler",            palette: "rust",   desc: "On-and-off the trampoline with weights. Earns its name.", lede: "On and off the trampoline with weights. Fifty minutes of intervals that earn their name — this one's not playing around.", burn: "~420 cal", goalLabel: "HIIT" },
];
...
/** Palette-tinted thumbnail placeholder (matches academy index `<Thumb>`) */
...
/** Related workout card — mirrors the w-card design from lr-tokens */
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        minHeight: 480, gap: 24, padding: "80px 40px", textAlign: "center",
      }}
    >
...
export default function WorkoutShowPage() {
  ...
  // Full-bleed helper: break out of the dashboard's 40px padding
  ...
  return (
    <div style={{ background: C.paper, minHeight: "100vh", fontFamily: FB, color: C.charcoal }}>
      ...
      >
        {/* Breadcrumb */}
        <nav style={{ maxWidth: 1200, margin: "0 auto", padding: "18px 0 6px", display: "flex", flexWrap: "wrap", gap: 6, alignItems: "center", fontFamily: FB, fontSize: 13, color: C.slate }}>
          ...
          <span style={{ color: C.mist }}>›</span>
          <span style={{ color: C.graphite }}>{workout.title}</span>
        </nav>

        {/* Video hero — max 880px centered */}
        <div style={{ maxWidth: 880, margin: "20px auto 0", position: "relative", borderRadius: 14, overflow: "hidden", background: C.charcoal, aspectRatio: "16/9", boxShadow: "0 4px 12px rgba(43,43,43,0.08), 0 2px 4px rgba(43,43,43,0.04)" }}>
          {workout.videoThumb ? (
            <img src={workout.videoThumb} alt={workout.title} style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} />
          ) : (
          ...
          {/* Rebounder Edition tag */}
          <span style={{
            position: "absolute", left: 16, top: 16, zIndex: 3,
            background: "rgba(255,255,255,0.92)", color: C.charcoal,
            fontFamily: FD, fontWeight: 800, fontSize: 11, letterSpacing: "0.12em", textTransform: "uppercase",
            padding: "7px 13px", borderRadius: 999,
          }}>Rebounder Edition</span>
          {/* Duration pill */}
          <span style={{
            position: "absolute", right: 16, bottom: 16, zIndex: 3,
            background: "rgba(43,43,43,0.78)", backdropFilter: "blur(4px)", color: "#fff",
            fontFamily: FD, fontWeight: 700, fontSize: 13, letterSpacing: "0.06em",
          ...
          <motion.a
            ...
            style={{
              ...
              background: C.orange, color: "#fff",
              boxShadow: "0 8px 24px rgba(252,162,72,0.35)",
              display: "flex", alignItems: "center", justifyContent: "center",
              textDecoration: "none",
            }}
          >
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 40px" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", gap: "14px 18px", marginTop: 18 }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
              {[workout.level, `${workout.duration} Minutes`].map(chip => (
                <span key={chip} style={{
                  fontFamily: FD, fontWeight: 700, fontSize: 12, letterSpacing: "0.08em", textTransform: "uppercase",
                  color: C.charcoal, background: C.orangeSoft, borderRadius: 999, padding: "7px 14px",
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginLeft: "auto" }}>
              ...
              {[
                { label: "Facebook", icon: <Facebook size={15} />, href: `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(typeof window !== "undefined" ? window.location.href : "")}` },
                { label: "Copy link", icon: linkCopied ? <CheckCircle size={15} /> : <Link2 size={15} />, onClick: handleCopyLink },
              ].map(btn => (
                <motion.button
                  key={btn.label}
                  ...
                  style={{
                    ...
                    border: `1px solid ${C.line}`, background: "#fff", color: C.charcoal,
        ...
        >
          ...
          <div>
            <article style={{
              color: C.graphite, fontFamily: FB, fontSize: 16.5, lineHeight: 1.72,
            }}>
              <style>{`
              ...
              <div className="article-body">
                ...
                <p>
                  ...
                  hands-on fitness experience as a personal trainer and group instructor, they make every session something you
                  actually look forward to — not just something you have to get through.
                </p>
              </div>
            </article>
          </div>
          ...
          <aside style={{ position: "sticky", top: 96, display: "flex", flexDirection: "column", gap: 18 }}>
            ...
            <div style={{ background: "#fff", border: `1px solid ${C.line}`, borderRadius: 14, overflow: "hidden" }}>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr" }}>
                {[
                  ...
                  <div key={f.k} style={{
                    padding: "14px 12px", display: "flex", flexDirection: "column", gap: 7,
                ...
                {[
                  ...
                  <div key={e.name} style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
                    <span style={{
                      ...
                      background: C.orangeWash, color: C.orangeDeep,
                      display: "flex", alignItems: "center", justifyContent: "center",
                    }}>
                      {e.icon}
                    </span>
            ...
            {/* Product CTA card — dark */}
            <div style={{ background: C.charcoal, color: "#fff", borderRadius: 14, overflow: "hidden", position: "relative" }}>
              <div style={{ aspectRatio: "16/10", background: C.orangeWash, position: "relative", overflow: "hidden" }}>
              ...
              <div style={{ padding: 20 }}>
                ...
                <p style={{ fontFamily: FB, fontSize: 13, color: "#D8D5CF", lineHeight: 1.55, margin: "0 0 16px" }}>
                  Whisper-quiet bungee cords — not springs — for 70% less joint impact. Ships 95% assembled. The exact rebounder built for workouts like this one.
                </p>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, marginBottom: 16 }}>
                  <div style={{ fontFamily: FD, fontWeight: 900, fontSize: 26 }}>
                ...
                <motion.a
                  ...
                  style={{
                    ...
                    width: "100%", padding: "15px 28px", borderRadius: 999,
                    background: C.orange, color: "#fff", textDecoration: "none",
                    fontFamily: FD, fontWeight: 800, fontSize: 15, letterSpacing: "0.08em", textTransform: "uppercase",
                    boxShadow: "0 4px 12px rgba(43,43,43,0.10)",
                  }}
                >
        ...
        <div style={{ maxWidth: 820 }}>
          ...
          <AnimatePresence>
            {!submitted ? (
              ...
              >
                {[
                  { id: "cname", label: "Name", type: "text", placeholder: "Your name", col: 1 },
                  { id: "cmail", label: "Email", type: "email", placeholder: "you@email.com", col: 1 },
                ].map(f => (
                  <div key={f.id} className="field">
                    <label htmlFor={f.id} style={{ display: "block", fontFamily: FD, fontWeight: 700, fontSize: 12, letterSpacing: "0.06em", textTransform: "uppercase", color: C.graphite, marginBottom: 7 }}>
                      {f.label}
                    </label>
                    <input
                      id={f.id} type={f.type} placeholder={f.placeholder}
                      value={f.id === "cname" ? commentForm.name : commentForm.email}
                      onChange={e => setCommentForm(prev => ({ ...prev, [f.id === "cname" ? "name" : "email"]: e.target.value }))}
                      style={{
                        width: "100%", fontFamily: FB, fontSize: 15, color: C.charcoal,
                ...
                <div style={{ gridColumn: "1 / -1" }}>
                  <label htmlFor="cmsg" style={{ display: "block", fontFamily: FD, fontWeight: 700, fontSize: 12, letterSpacing: "0.06em", textTransform: "uppercase", color: C.graphite, marginBottom: 7 }}>
                    Comment
                  </label>
                  <textarea
                    id="cmsg"
                    ...
                    style={{
                      width: "100%", fontFamily: FB, fontSize: 15, color: C.charcoal,
                      background: "#fff", border: `1px solid ${C.line}`, borderRadius: 8,
                      padding: "12px 14px", outline: "none", resize: "vertical", minHeight: 110, boxSizing: "border-box",
                    }}
                  />
                </div>
                <div style={{ gridColumn: "1 / -1" }}>
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    style={{
                      fontFamily: FD, fontWeight: 800, textTransform: "uppercase", letterSpacing: "0.08em",
                      background: C.orange, color: "#fff", border: "none", borderRadius: 999,
              ...
              >
                ...
                <span style={{ fontFamily: FB, fontSize: 15, color: C.graphite }}>
          ...
          <div style={{ fontFamily: FD, fontWeight: 800, textTransform: "uppercase", fontSize: 14, color: C.charcoal, margin: "26px 0 6px" }}>
            0 comments
          </div>
          <div style={{ fontFamily: FB, fontSize: 14, color: C.slate }}>
            No comments yet — be the first to bounce in.
          </div>
        </div>
      </section>
      ...
      >
        ...
        <div style={{
          ...
          backgroundImage: `url("data:image/svg+xml,%3Csvg width='40' height='40' viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M5 35 Q20 5 35 35' stroke='%23FCA248' stroke-width='1.2' fill='none'/%3E%3C/svg%3E")`,
          backgroundSize: "80px",
        }} />
        <div style={{ ...wrap, position: "relative", display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: 24, alignItems: "center" }}>
          <div>
            <div style={{ fontFamily: FD, fontWeight: 700, fontSize: 13, letterSpacing: "0.14em", textTransform: "uppercase", color: C.orange, marginBottom: 14 }}>
            ...
            <h2 style={{ fontFamily: FD, fontWeight: 900, textTransform: "uppercase", lineHeight: 1.02, fontSize: "clamp(30px, 4vw, 52px)", margin: "0 0 16px" }}>
              Try our rebounder{" "}
              <em style={{ fontStyle: "normal", color: C.orange }}>risk-free</em>
            </h2>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 14, alignItems: "center" }}>
              ...
              <motion.a
                ...
                style={{
                  display: "inline-flex", alignItems: "center", gap: 8,
                  background: "#fff", color: C.charcoal, textDecoration: "none",
                  fontFamily: FD, fontWeight: 800, fontSize: 15, letterSpacing: "0.08em", textTransform: "uppercase",
                  padding: "15px 28px", borderRadius: 999,
                }}
              >
