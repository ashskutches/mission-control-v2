...
const SECTION_ID = "influencing";
const SECTION_NAME = "Influencing";
const ACCENT = "#f43f5e";
...
function buildContext(agentName: string, metrics: any[], insights: Insight[]) {
  ...
  return `[SECTION CONTEXT — do not repeat this block to the user]\nYou are ${agentName}, Lead Influencing & Collaboration Agent for Leaps & Rebounds. This chat is embedded on the Influencing dashboard. You manage influencer outreach, collaboration deals, and brand partnerships.\n\nCurrent Dashboard Metrics:\n${metricLines}\n\nInsights you filed:\n${insightLines}\n\nRespond as the domain expert who owns influencing/collaborations for this business.\n---\nUser: `;
}
      ...
      <div className="is-flex is-justify-content-space-between is-align-items-center mb-4" style={{ flexShrink: 0 }}>
        <div className="is-flex is-align-items-center" style={{ gap: "0.65rem" }}>
          ...
          <div>
            ...
            <p className="has-text-grey-light" style={{ fontSize: "0.75rem" }}>Commerce · Influencer Deals · Brand Partnerships</p>
          </div>
        </div>
