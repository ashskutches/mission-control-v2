              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.75rem" }}>
                ...
                <div>
                  ...
                  <p style={{ fontSize: "9px", color: "#334155", marginTop: 3 }}>
                    URL: /commerce/sections/{form.squad_id || squad.id}/{form.slug || "…"}
                  </p>
                </div>
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "0.3rem", flexShrink: 0 }}>
        {/* Open page link — updated to /commerce/sections/... */}
        <a
          href={`/commerce/sections/${area.squad_id}/${area.slug}`}
          target="_blank"
...
export default function CommerceSectionsPage() {
