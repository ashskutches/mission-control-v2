"use client";
/**
 * Dynamic commerce section page — handles any /commerce/sections/[squad]/[area] route
...
export default function DynamicCommerceSectionsPage({
  params,
}: {
      ...
      <div style={{ padding: "3rem 2rem", textAlign: "center" }}>
        ...
        <p style={{ color: "#64748b", fontSize: "0.875rem" }}>
          <code style={{ fontFamily: "monospace", color: "#94a3b8" }}>
            /commerce/sections/{squadSlug}/{areaSlug}
          </code>{" "}
          doesn&apos;t exist yet.
        </p>
        <a
          href="/commerce/sections"
          style={{
