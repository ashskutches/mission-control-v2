...
export default function CommerceDashboardPage() {
  ...
  const onNav = (squadId: string, areaSlug: string) =>
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
      ...
      <div>
        ...
        <div className="columns is-multiline">
          ...
          <div className="column is-4">
            <StatCard
              label="30-Day Sales"
              value={shopify ? `$${Number(shopify.total30d || 0).toLocaleString()}` : "—"}
              subValue="Rolling 30-day gross"
          ...
          <div className="column is-4">
            <StatCard
              ...
              value={forecast?.estimatedMonthEnd ? `$${Number(forecast.estimatedMonthEnd).toLocaleString()}` : "—"}
              subValue="Projected from MTD pace"
        ...
        <div className="columns is-multiline">
          ...
          <div className="column is-4">
            <StatCard
              ...
              value={shopify?.aov ? `$${shopify.aov}` : "—"}
              subValue="Rolling AOV"
              color="#38bdf8"
              icon={ShoppingBag}
            />
          </div>
      ...
      {/* ── Sections Overview ── */}
      <div>
        <p style={{ fontSize: 9, fontWeight: 800, color: "#444", textTransform: "uppercase", letterSpacing: "0.12em", margin: "0 0 16px" }}>
          Sections Overview
        </p>
        {loadingSquads ? (
          ...
          squads.map((squad, i) => (
            <React.Fragment key={squad.id}>
              {i > 0 && <div style={{ height: 1, background: "rgba(255,255,255,0.05)", margin: "1.5rem 0" }} />}
