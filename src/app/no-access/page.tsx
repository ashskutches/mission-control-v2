...
const REASONS: Record<string, { title: string; body: string }> = {
    ...
    no_role: {
        ...
        body: "You're in the Discord, but you don't have a role that grants dashboard access. Ask an admin to give you the Teammate role — or Admin for Profit, Costs, Agents and Quick Run.",
    },
};
